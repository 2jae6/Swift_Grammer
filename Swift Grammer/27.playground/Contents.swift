...
let resultOne = saySomething(getWords: getMyWords, firstInput: "안녕하세요." , lastInput: "개발하는 정대리입니다.")
print("resultOne: \(resultOne)")

let resultTwo = saySomething(getWords: getMyWordsTwice, firstInput: "안녕하세요.", lastInput: "개발하는 정대리입니다.")
